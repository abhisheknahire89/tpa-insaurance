...
export const ICD_SYNONYM_MAP: IcdSynonym[] = [
  ...
  { term: "asthma", code: "J45.909", note: "Unspecified asthma" },
  { term: "dama", code: "J45.909", note: "Unspecified asthma" },
  { term: "saans phoolna", code: "J45.909", note: "Unspecified asthma" },
  ...
  { term: "tb", code: "A16.2", note: "Tuberculosis of lung" },
  { term: "tuberculosis", code: "A16.2", note: "Tuberculosis of lung" },
  { term: "tapedik", code: "A16.2", note: "Tuberculosis of lung" },
  ...
  { term: "dka", code: "E11.10", note: "Type 2 diabetes mellitus with ketoacidosis without coma" },
  ...
  { term: "gallstone", code: "K80.20", note: "Calculus of gallbladder" },
  { term: "pitta patthar", code: "K80.20", note: "Calculus of gallbladder" },
  ...
  { term: "typhoid", code: "A01.00", note: "Typhoid fever, unspecified" },
  { term: "enteric fever", code: "A01.00", note: "Enteric/Typhoid fever" },
  { term: "miyadi bukhar", code: "A01.00", note: "Typhoid fever" },
  ...
  { term: "cellulitis", code: "L03.90", note: "Cellulitis, unspecified" },
  { term: "anemia", code: "D64.9", note: "Anemia, unspecified" },
  { term: "khoon ki kami", code: "D64.9", note: "Anemia, unspecified" },
  { term: "ulti", code: "R11.10", note: "Vomiting (Ulti)" },
  { term: "vomiting", code: "R11.10", note: "Vomiting, unspecified" },
  { term: "constipation", code: "K59.00", note: "Constipation, unspecified" },
  { term: "kabz", code: "K59.00", note: "Constipation, unspecified" },

  // Injuries
  { term: "fracture", code: "T14.8", note: "Fracture/injury unspecified Body region" },
  { term: "haddi tootna", code: "T14.8", note: "Fracture" },
  { term: "head injury", code: "S09.90", note: "Unspecified injury of head" },
  { term: "sir me chot", code: "S09.90", note: "Unspecified injury of head" }
];
